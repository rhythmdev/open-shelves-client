    ...
    return (
        <div className="py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-5 items-center py-10">
                <div className="text-center space-y-4 bg-gray-50 dark:bg-gray-800 px-8 py-6 rounded-md cursor-pointer shadow-md shadow-gra-end hover:border-2 border-orange-400 w-full h-[330px] ">
